...
public static class BookSpecs
{
    ...
    public static Expression<Func<Book, bool>> ByAuthorId(Guid id) =>
        book => book.AuthorsCollection.Any(author => author.Person.Id == id);
    ...
    public static ISpecification<Book> ByAuthorId(this ISpecification<Book> spec, Guid id) => spec.And(ByAuthorId(id));
